...
const downloadLogger = createContextLogger('api-updates-host-download');
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    if (!(await versionExists('host', version))) {
    ...
    const downloadUrl = await getVersionDownloadUrl('host', version, platform);
    ...
    downloadLogger.error('Host download API error', { 
