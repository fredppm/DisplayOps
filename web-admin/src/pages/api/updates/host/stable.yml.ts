...
const updatesLogger = createContextLogger('api-updates-host-stable');
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    updatesLogger.info('Electron updater checking for host stable updates', { 
      platform,
...
releaseDate: '${updateInfo.releaseDate}'`;
    ...
    updatesLogger.error('Host stable updates API error', { 
