  ...
  React.useEffect(() => {
    const fetchVersion = async (attempt = 1) => {
      try {
        ...
        // Different endpoints for host vs extension
        const endpoint = app === 'host' 
          ? `/api/updates/${app}?platform=win32`
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center space-x-3">
          <div className={`h-10 w-10 ${app === 'host' ? 'bg-blue-50 dark:bg-blue-900/20' : 'bg-purple-50 dark:bg-purple-900/20'} rounded-lg flex items-center justify-center`}>
            {app === 'host' ? (
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                  <DownloadButton 
                    title="Host Agent"
                    description="Desktop app for displays"
                    app="host"
                  />
                  
                  <DownloadButton 
                    title="Browser Extension"
                    description="Cookie sync for Chrome/Edge"
                    app="extension"
                  />
                </div>
              </div>
