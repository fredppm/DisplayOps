...
export const DisplayCard: React.FC<DisplayCardProps> = ({
  ...
  const getDisplayStatus = (displayId: string) => {
    ...
    if (!display) return { status: 'unknown', text: 'Unknown', color: 'text-gray-500 dark:text-gray-400' };
    ...
    return { status: 'empty', text: 'No Content', color: 'text-gray-500 dark:text-gray-400' };
  };
      ...
      <div className="card hover:shadow-md transition-all duration-200">
          ...
          <div className="grid gap-4 items-stretch" style={{
            ...
            <div className="col-span-1">
              <div className="flex items-center mb-2">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">{host.hostname}</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{host.ipAddress}</p>
                </div>
              </div>
            ...
            {host.displays.map((displayId) => {
              ...
              return (
                <div key={displayId}>
                  <div className="h-full flex flex-col border border-gray-200 dark:border-gray-700 rounded-lg p-3 bg-white dark:bg-gray-800">
                    <div className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1 text-center">
        ...
        <div className="lg:hidden space-y-4">
          ...
          <div className="space-y-3">
            {host.displays.map((displayId) => (
              <div key={displayId} className="border border-gray-200 dark:border-gray-700 rounded-lg p-3 bg-white dark:bg-gray-800">
          ...
          <div className="pt-3 border-t">
            ...
            {host.debugEnabled && (
              <div className="pt-3 border-t">
                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Debug Logs</h4>
                <div className="flex gap-2">
                  <button
                    onClick={() => onDownloadDebugEvents?.(host.id)}
                    disabled={!host.metrics.online}
